...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TripMind AI — Plan smarter trips with AI" },
      {
        name: "description",
        content:
          "TripMind AI is your intelligent travel co-pilot. Generate day-by-day itineraries, track budgets, and discover destinations in seconds.",
      },
      { name: "author", content: "TripMind AI" },
